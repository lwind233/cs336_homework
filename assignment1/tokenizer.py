...
from assignment1.bpe_v7 import train_tokenizer
...
if __name__ == '__main__':
    # a = Tokenizer.from_files('assignment1-basics-main/tests/fixtures/gpt2_vocab.json','assignment1-basics-main/tests/fixtures/gpt2_merges.txt')
    input_path = 'assignment1-basics-main/tests/fixtures/tinystories_sample_5M.txt'
    vocab_size = 1000
    special_tokens = "<|endoftext|>", "<|endoftext|><|endoftext|>"
    vocab,merges = train_tokenizer(input_path,vocab_size,special_tokens)
    # print(vocab)    
    a = Tokenizer(vocab,merges,special_tokens=special_tokens)

    test_string = "Hello, how <|endoftext|><|endoftext|> are you?<|endoftext|>"
    encoded_ids = a.encode(test_string)
    print(encoded_ids)
    # tokenized_string = a.decode(encoded_ids)
    tokenized_string = [a.decode([x]) for x in encoded_ids]
